...
$arr = $w3cview->select("returninfor", "id='".$_GET['id']."'");
?>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
  ...
  <TD style="PADDING-LEFT: 20px; FONT-WEIGHT: bold; COLOR: #ffffff" 
    align=left background=images/title_bg2.jpg>当前位置: 修改自动回复消息</TD></TR>
</TABLE>
<form method='post' action='editreturninforsave.php' name='myform' onsubmit="return chk(this);">  
  <TABLE cellSpacing=0 cellPadding=2 width="80%" align=center border=0>
    <TR>
      <TD align=center>关键词：</TD>
      <TD style="COLOR: #880000"><input name="keyword" type="text" id="keyword" value="<?php echo $arr['keyword'];?>" size="50"></TD>
    </TR>
    <TR>
    ...
    <TR>
      ...
      <TD style="COLOR: #880000"><textarea name="url" cols="70" rows="3" id="url"><?php echo $arr['url'];?></textarea></TD>
    </TR>
    <TR>
    ...
    <TR>
      ...
      <TD style="COLOR: #880000"><textarea name="description" cols="50" rows="5" id="description"><?php echo $arr['description'];?></textarea></TD>
    </TR>
    <TR>
