...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
  <TR height=22>
  <TD style="PADDING-LEFT: 20px; FONT-WEIGHT: bold; COLOR: #ffffff" align=left background=images/title_bg2.jpg>当前位置: 关注回复管理</TD></TR>
</TABLE>
...
<?php
$couple = array("序号"=>"id", "标题"=>"title", "发布时间"=>"timer");
$keyword = array("title"=>$_REQUEST['keyword']);
$w3cview->page("message", "id", $couple, 10, $_GET['page'], $_POST['delid'], 0, $_SESSION['editdel'], $_SESSION['editdel'], $keyword, "添加消息");
?>
</BODY>
</HTML>