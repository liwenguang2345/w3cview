...
$arr = $w3cview->select("news", "id='".$_GET['id']."'");
?>
...
<BODY onload="show(<?php echo $arr['newsclass'];?>)">
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
  ...
  <TD style="PADDING-LEFT: 20px; FONT-WEIGHT: bold; COLOR: #ffffff" 
    align=left background=images/title_bg2.jpg>当前位置: 修改信息</TD></TR>
</TABLE>
<form method='post' action='editnewssave.php' name='myform' onsubmit="return chk(this);">  
  <TABLE cellSpacing=0 cellPadding=2 width="80%" align=center border=0>
    ...
    <TR>
      ...
      <TD style="COLOR: #880000"><input type="text" name="keywords" id="keywords" value="<?php echo $arr['keywords'];?>"></TD>
    </TR>
    <TR>
      <TD align=center>搜索描述description：</TD>
      <TD style="COLOR: #880000"><input type="text" name="description" id="description" value="<?php echo $arr['description'];?>"></TD>
    </TR>
    <TR>
      <TD align=center>信息图片：</TD>
      <TD style="COLOR: #880000">
      <input name="image" id="image" style='width:300px;' value="<?php echo $arr['image'];?>">
    ...
    <TR>
      ...
      <TD style="COLOR: #880000"><textarea id="note" name="note" style="width:100%;height:650px;visibility:hidden;"><?php echo $arr['note'];?></textarea></TD>
    </TR>
    <TR>
